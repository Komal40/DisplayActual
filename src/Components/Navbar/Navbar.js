...
export default function Navbar() {
  ...
  return (
    ...
    <div>
     ...
     <div><FaArrowRight onClick={()=>handleClick()} className={closeMenu?'right_arrow_active':'right_arrow'} />
     <FaArrowRight onClick={handleUpdateClick} className={showUpdateOptions ? 'right_arrow_active' : 'right_arrow'} /></div>
        ...
        <ul >
            ...
            <li className="dropdown">
                                <span className='dashboard_items' onClick={handleFloorClick}>UPDATE FLOOR</span>
                                {showFloorOptions && (
                                    <div className="dropdown-menu">
                                        <li><HashLink to='/update' className='dashboard_items'>LINES</HashLink></li>
                                        <li><HashLink to='/parts' className='dashboard_items'>PARTS</HashLink></li>
                                        <li><HashLink to='/process' className='dashboard_items'>PROCESS</HashLink></li>
                                        <li><HashLink to='/para' className='dashboard_items'>PARAMETERS</HashLink></li>
                                    </div>
                                )}
            </li>
            {/* <li><HashLink to='/prevdata' className='dashboard_items'>Previous Data</HashLink></li> */}
            
            <li><HashLink to='/register' className='dashboard_items'>ADD OPERATOR</HashLink></li>
            ...
            <hr style={{width:'100%'}}/>
            <li onClick={handleLogout}><HashLink className='dashboard_items' >LOG OUT</HashLink></li>
        </ul>
        </div>
      </nav>
    </div>
